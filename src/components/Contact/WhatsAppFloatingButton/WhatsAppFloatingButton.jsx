...
const WhatsAppFloatingButton = () => {
  ...
  return (
    // Wrap in AnimatePresence to handle mounting/unmounting during page changes
    <AnimatePresence mode="wait">
      <motion.div 
        key="whatsapp-float" // Key helps React track it across page changes
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed bottom-8 right-8 z-[999] flex flex-col items-end gap-2"
      >
        
        {/* 1. Label - Increased delay slightly to ensure page has loaded */}
        <motion.div
        ...
        <div className="relative group">
          ...
          {/* 3. Main Button - Changed initial to 0.1 instead of 0 for better reliability */}
          <motion.a
            href={whatsappUrl}
            target="_blank"
            ...
            transition={{ 
              ...
              stiffness: 260, 
              damping: 20,
              delay: 0.2 // Small delay so it pops in after the page transition
            }}
