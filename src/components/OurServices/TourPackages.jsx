  ...
  return (
    <HelmetProvider>
      ...
      <div className="bg-gray-50 min-h-screen pb-20">
        {/* --- MODERN HERO SECTION --- */}
        <div className="relative bg-[#005a31] py-24 lg:py-32 px-4 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight">
              Explore the World <span className="text-green-300">With Us</span>
            </h1>
            <p className="text-green-50 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button 
                ...
                className="bg-white text-[#005a31] px-8 py-4 rounded-full font-bold shadow-lg hover:bg-green-50 transition transform hover:-translate-y-1"
              >
                🌍 International Tours
              </button>
              <button 
                onClick={() => scrollToSection(domRef)}
                className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-bold hover:bg-white/10 transition transform hover:-translate-y-1"
              >
                🇧🇩 Domestic Tours
              </button>
            </div>
