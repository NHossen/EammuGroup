...
const SouthKoreaVisa = () => {
  return (
    <>
  <Helmet>
  <title>South Korea Visa Application And Requirements | Get Visa Assistance – Eammu Holidays</title>
  ...
  <meta property="og:url" content="https://eammu.com/south-korea-visa-application" />
  <meta
    property="og:image"
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "provider": {
        "@type": "TravelAgency",
        "name": "Eammu Holidays",
        "url": "https://eammu.com/south-korea-visa-application",
        ...
        <section className="bg-[#005a31] py-20 px-6 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tighter uppercase">
              South <span className="text-orange-500">Korea</span> visa Application – Requirements, Process & Fees
            </h1>
