...
import { CheckCircle, ClipboardList, Send, Globe, ShieldCheck, FileText, Landmark, Palmtree } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              ...
              <div className="space-y-10">
                <StepItem 
                  number="01" 
                  title="Entry Type Assessment" 
                  desc="We check if you qualify for visa-free entry (Schengen/US/UK visa holders) or if you need an Albania E-Visa." 
                />
                <StepItem 
                  number="02" 
                  title="E-Visa Portal Management" 
                  desc="Comprehensive handling of the 'e-Visa Albania' portal, including accurate data entry and document digital formatting." 
                />
                <StepItem 
                  number="03" 
                  title="Notarization & Translation" 
                  desc="Assisting with the necessary document translations into Albanian if required for work or long-term stay permits." 
                />
                <StepItem 
                  number="04" 
                  title="Final Approval & E-Visa Grant" 
                  desc="Tracking the application through the Ministry of Interior and notifying you once the electronic visa is granted." 
                />
              </div>
            </section>
            ...
            <section className="bg-slate-50 p-10 md:p-14 rounded-[3rem] border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <RequirementCard text="Digital Photo (Passport size, white background)" />
                <RequirementCard text="Travel Medical Insurance (Minimum €30,000 coverage)" />
                <RequirementCard text="Proof of Employment (NOC or Work Contract)" />
                <RequirementCard text="Proof of Sufficient Financial Means (Bank Statement)" />
                <RequirementCard text="Confirmed Hotel Booking / Letter of Invitation" />
                <RequirementCard text="Round-trip Flight Ticket Reservation" />
                <RequirementCard text="Police Clearance Certificate (For Work Permits)" />
                <RequirementCard text="Birth Certificate / Marriage Certificate (If applicable)" />
                <RequirementCard text="Valid Residence Permit (If applying from UAE/GCC)" />
              </div>
            </section>
