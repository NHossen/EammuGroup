...
import { CheckCircle, ClipboardList, Send, Globe, ShieldCheck, FileText, Users } from 'lucide-react';
        ...
        <section className="max-w-7xl mx-auto py-20 px-6 grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              ...
              <div className="space-y-10">
                <StepItem 
                  ...
                  desc="We assess your profile, financial background, and purpose of travel to choose the right visa category (Tourist, Student, or Business)." 
                />
                <StepItem 
                  number="02" 
                  title="Form DS-160 Filing" 
                  desc="Our experts help you complete the complex online DS-160 form with 100% accuracy, which is critical for a successful outcome." 
                />
                <StepItem 
                  number="03" 
                  title="Fee Payment & Scheduling" 
                  desc="We manage the MRV visa fee payment and assist in booking your Biometric (VAC) and Embassy Interview appointments." 
                />
                <StepItem 
                  number="04" 
                  title="Mock Interview & Training" 
                  desc="A dedicated session where we prepare you for potential questions from the Consular Officer to boost your confidence." 
                />
              </div>
            </section>
            ...
            <section className="bg-slate-50 p-10 md:p-14 rounded-[3rem] border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-10">
                ...
                <h2 className="text-3xl font-black text-[#005a31] uppercase tracking-tight">Mandatory Requirements</h2>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <RequirementCard text="Valid Passport (at least 6 months validity beyond stay)" />
                <RequirementCard text="All Old Passports (if any) to show travel history" />
                <RequirementCard text="Digital & Physical Photo (2x2 inch, white background)" />
                <RequirementCard text="Confirmation Page of Form DS-160" />
                <RequirementCard text="Visa Fee Payment Receipt (MRV Fee)" />
                <RequirementCard text="Appointment Confirmation Page" />
                <RequirementCard text="Personal & Company Bank Statement (Last 6 Months)" />
                <RequirementCard text="Proof of Profession (Trade License or NOC/Pay Slip)" />
                <RequirementCard text="Asset Valuation (If applicable)" />
                <RequirementCard text="I-20 Form (Specifically for F1 Student Visa)" />
              </div>
            </section>
          ...
          <aside className="space-y-8 lg:sticky lg:top-10">
            ...
            <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 flex flex-col items-center text-center">
              ...
              <p className="text-[#005a31] font-black text-xl">EAMMU.COM</p>
            </div>
          </aside>
