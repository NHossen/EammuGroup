...
import { CheckCircle, ClipboardList, Send, Globe, ShieldCheck, FileText, Landmark, Castle } from 'lucide-react';
      ...
      <main className="bg-white min-h-screen font-sans">
        ...
        <section className="bg-[#005a31] py-20 px-6 text-center text-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-10 flex items-center justify-center">
             <Castle size={400} className="text-white" />
          </div>
        ...
        <section className="max-w-7xl mx-auto py-20 px-6 grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              ...
              <div className="space-y-10">
                <StepItem 
                  number="01" 
                  title="Visa Category Identification" 
                  desc="We help you determine if you need a Type C (Short-stay) or Type D (Long-stay) visa based on your travel or business goals." 
                />
                <StepItem 
                  number="02" 
                  title="Invitation Letter (Voucher)" 
                  desc="For Serbia, an official invitation letter or hotel voucher is crucial. We guide you on obtaining these from authorized Serbian entities." 
                />
                <StepItem 
                  number="03" 
                  title="Application Submission" 
                  desc="Management of your appointment at the Embassy or Consulate of Serbia, ensuring your application form and supporting files are flawless." 
                />
                <StepItem 
                  number="04" 
                  title="Residency Consultancy" 
                  desc="If you are looking to stay longer, we offer specialized services for obtaining a Temporary Residence Permit (Boravak) based on work or business." 
                />
              </div>
            </section>
            ...
            <section className="bg-slate-50 p-10 md:p-14 rounded-[3rem] border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <RequirementCard text="Valid Passport (at least 90 days remaining from travel date)" />
                <RequirementCard text="Completed Visa Application Form" />
                <RequirementCard text="One Recent Photo (3.5 x 4.5 cm, white background)" />
                <RequirementCard text="Official Invitation Letter (Certified by Serbian authorities)" />
                <RequirementCard text="Proof of Sufficient Funds (Bank Statement for last 6 months)" />
                <RequirementCard text="Travel Medical Insurance (Min. €20,000 coverage)" />
                <RequirementCard text="Confirmed Return Flight Ticket" />
                <RequirementCard text="NOC from Employer / Business License" />
                <RequirementCard text="Valid Residence Permit (For UAE/Armenia applicants)" />
          ...
          <aside className="space-y-8 lg:sticky lg:top-10">
            ...
            <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 flex flex-col items-center text-center">
              ...
              <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">Trusted Agency</p>
