...
import { CheckCircle, ClipboardList, Send, Globe, ShieldCheck, FileText, Landmark, GraduationCap } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              ...
              <div className="space-y-10">
                <StepItem 
                  number="01" 
                  title="Eligibility & Path Selection" 
                  desc="We analyze your education and skills to decide between a Student Visa, Job Seeker Visa, or the new Opportunity Card (Chancenkarte)." 
                />
                <StepItem 
                  number="02" 
                  title="Document Legalization" 
                  desc="Assisting with the translation and legalization of your academic/professional documents as per German Embassy standards." 
                />
                <StepItem 
                  number="03" 
                  title="Blocked Account & Health Insurance" 
                  desc="We guide you in opening a 'Blocked Account' (Sperrkonto) and securing Incoming Health Insurance required for Germany." 
                />
                <StepItem 
                  number="04" 
                  title="Interview & VFS Submission" 
                  desc="We schedule your appointment at VFS Global or the German Embassy and prepare you for the visa interview." 
                />
              </div>
            </section>
            ...
            <section className="bg-slate-50 p-10 md:p-14 rounded-[3rem] border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <RequirementCard text="Valid Passport with minimum 6 months validity" />
                <RequirementCard text="Two Biometric Photos (German Embassy Specification)" />
                <RequirementCard text="German Language Certificate (A1, B1, or B2 if applicable)" />
                <RequirementCard text="Blocked Account Proof (approx. €11,208 for one year)" />
                <RequirementCard text="University Admission Letter (For Students)" />
                <RequirementCard text="ZAB Evaluation for Job Seekers (Anabin)" />
                <RequirementCard text="Professional Resume (German/Europass Format)" />
                <RequirementCard text="Proof of Accommodation in Germany" />
                <RequirementCard text="Comprehensive Health Insurance Coverage" />
                <RequirementCard text="Detailed Motivation Letter (Statement of Purpose)" />
              </div>
            </section>
