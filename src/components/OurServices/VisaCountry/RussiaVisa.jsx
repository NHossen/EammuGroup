      ...
      <main className="bg-white min-h-screen font-sans text-slate-900">
        ...
        <section className="max-w-7xl mx-auto -mt-12 px-6 relative z-20">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <MetricBox label="e-Visa Time" value="4 Calendar Days" icon={<Clock size={20}/>} />
                <MetricBox label="Visa Category" value="e-Visa / Tourist" icon={<FileText size={20}/>} />
                <MetricBox label="New Rule 2026" value="Digital Entry Permit" icon={<Globe size={20}/>} />
                <MetricBox label="Partner" value="Artel / MFA Russia" icon={<Landmark size={20}/>} />
            </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col items-center mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-4xl font-black text-[#005a31] uppercase">Russia Visa Insights</h2>
              </div>
              <p className="text-gray-500 text-center max-w-2xl italic font-medium">Expert tutorials on the Unified e-Visa portal, obtaining a Tourist Voucher, and the 2026 Dubai-Moscow travel protocols.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard 
                id="RUSSIA_E_VISA_2026" 
                title="The Unified e-Visa" 
                desc="A complete guide to applying for the 16-day electronic visa available for 55+ eligible nationalities."
              />
              <VideoCard 
                id="RUSSIA_VOUCHER_EXPLAINED" 
                title="Tourist Invitations" 
                desc="How to obtain the mandatory 'Tourist Voucher' and 'Confirmation' document from a licensed Russian tour operator."
              />
              <VideoCard 
                id="RUSSIA_PHOTO_SPECS" 
                title="Strict Photo Rules" 
                desc="Avoid rejection! Learn the specific facial dimensions and rectangular framing required by the Russian MFA."
              />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-4 mb-12 border-b border-gray-100 pb-6">
              ...
              <h2 className="text-4xl font-black text-[#005a31] uppercase">Russian Pathways</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              />
              <PosterCard 
                image="https://images.unsplash.com/photo-1561542320-9a18cd340469" 
                badge="Private" 
                title="Homestay Visa" 
                detail="Family Visit"
              />
        ...
        <section className="max-w-7xl mx-auto py-20 px-6 grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
          ...
          <div className="lg:col-span-2 space-y-20">
            ...
            <section id="procedure">
              ...
              <div className="space-y-10">
                <StepItem 
                  ...
                  desc="Issuing the official invitation from a registered Russian travel agency to initiate your visa file." 
                />
                <StepItem 
                  number="02" 
                  title="MFA Portal Entry" 
                  desc="Accurately completing the electronic application form on the Ministry of Foreign Affairs website." 
                />
                <StepItem 
                  number="03" 
                  title="Document Review" 
                  desc="Double-checking your UAE residency and passport validity to ensure compliance with Russian entry laws." 
                />
                <StepItem 
                  number="04" 
                  title="Final Issuance" 
                  desc="Receiving your e-Visa PDF or collecting your passport with the physical visa sticker from the Consulate." 
                />
              </div>
            </section>
            ...
            <section className="bg-slate-50 p-10 md:p-14 rounded-[3rem] border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <RequirementCard text="UAE Residence Visa Copy" />
                <RequirementCard text="Russian Tourist Voucher & Confirmation" />
                <RequirementCard text="Signed MFA Application Form" />
                <RequirementCard text="2 Rectangular Biometric Photos (35x45mm)" />
                <RequirementCard text="Travel Insurance valid in Russia" />
                <RequirementCard text="Flight Booking (Confirmed/Itinerary)" />
                <RequirementCard text="NOC Letter from UAE Employer" />
                <RequirementCard text="Hotel Confirmation in Russia" />
                <RequirementCard text="HIV Test Certificate (For stays over 90 days)" />
              </div>
              ...
              <div className="mt-12 p-6 bg-white rounded-2xl border border-orange-100 flex gap-4 items-start">
                ...
                <div>
                    <p className="text-sm font-bold text-[#005a31] uppercase">Russian Consular Photo Standards</p>
                    <p className="text-xs text-gray-500 mt-1">
                        Photos must be **rectangular** and have **full width and height** within the frame. Background must be plain white, and the face must occupy 70-80% of the image.
                    </p>
                </div>
              </div>
            </section>
            ...
            <section>
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <h2 className="text-3xl font-black text-[#005a31] uppercase tracking-tight">Russia Visa FAQ</h2>
                </div>
                <div className="divide-y divide-gray-100">
                    <FAQItem 
                        question="Which nationalities can apply for the e-Visa?" 
                        answer="The Unified e-Visa is available for citizens of 55 countries, including India, China, and several EU states. Others must apply for a sticker visa."
                    />
                    <FAQItem 
                        question="How long can I stay on a Unified e-Visa?" 
                        answer="The e-Visa allows for a stay of up to 16 days within a 60-day validity window from the date of issue."
                    />
                    <FAQItem 
                        question="Is travel insurance mandatory?" 
                        answer="Yes, Russian immigration requires proof of travel insurance that specifically covers the territory of the Russian Federation for the entire duration of stay."
                    />
                </div>
            </section>
          ...
          <aside className="space-y-8 lg:sticky lg:top-10">
            <div className="bg-[#005a31] text-white p-10 rounded-[3rem] shadow-2xl overflow-hidden relative group">
              ...
              <h3 className="text-2xl font-black mb-8 border-b border-white/10 pb-4 italic text-orange-400">Russia Desk</h3>
