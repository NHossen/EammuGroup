...
const TargetUsaSection = () => {
    return (
        <div>
                  <div>
        <h1 className="mt-6 text-3xl text-center font-bold">Target <span className="text-[#d33232]">USA</span> Visa Interview Preparation</h1>
