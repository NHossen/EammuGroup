...
const EammuImmigrationHeading_2 = () => {
  ...
  <div className="max-w-6xl">
    <h1 className="text-3xl font-bold text-[#005a31] ">Eammu Immigration Services</h1>
    <h2 className="text-xl font-medium mt-10">Premier Study Abroad Agency Cumilla, Bangladesh |Excellence in Education Consultancy Services </h2>
      ...
      <Link to='/eammuimmigrationservices'><h3 className="hover:shadow-[#bfc0bf] hover:shadow-lg btn text-lg hover:bg-[#005a31] hover:text-[#ffffff] bg-white text-[#005a31]  border-[1.5px] border-[#005a31]">Explore More</h3> </Link>
    </div>
  </div>
</div>
        </div>
