      ...
      <div className="flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-base text-gray-700 leading-relaxed mb-6">
            Eammu Immigration Services, based in Cumilla, Bangladesh, is a trusted educational consultancy firm with over six years of experience. Since 2018, we’ve been guiding students to top global universities, securing scholarships and financial aid.
            <br /><br />
