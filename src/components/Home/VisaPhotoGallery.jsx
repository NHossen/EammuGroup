    ...
    <section className="py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 text-left border-l-8 border-[#005a31] pl-6">
          ...
          <p className="text-slate-500 font-medium mt-2">Eammu Holidays is leading online travel agency in bangladesh provides professional worldwide visa application assistance for travelers, tourists, and business visitors.</p>
        </div>
