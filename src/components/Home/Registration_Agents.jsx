...
<p className="text-2xl font-bold text-[#005a31]">শীঘ্রই রেজিস্ট্রেশন করুন</p>
    <div className="card-actions justify-end">
      <button className="hover:shadow-[#005a31] hover:shadow-lg btn text-lg hover:bg-[#005a31] hover:text-[#ffffff] bg-white text-[#072504]  border-[1.5px] border-[#072504]"><a href="https://rb.gy/si1vi9">Register Now</a> </button>
    </div>
  </div>
</div>
        </div>
