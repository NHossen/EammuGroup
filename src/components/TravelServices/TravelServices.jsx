...
const TravelServices = () => {
  ...
  const visaData = [
    { id: 1, title: "Tourist Visa Assistance by Eammu Holidays", img: "https://eam-global.com/wp-content/uploads/2025/03/Tourist-Visa.jpg", link: "/visa-services/tourist-visa-application-from-bangladesh" , details: "Tourist Visa Application"},
    { id: 2, title: "Study Abroad From Bangladesh with Eammu", img: "https://www.unidirection.com/wp-content/uploads/2019/10/study-abroad.png", link: "/visa-services/student-visa-application-from-bangladesh", details: "Student Visa Application"},
    { id: 3, title: "IELTS And Visa Interview Preparation with Eammu", img: "https://galvanizetestprep.com/wp-content/uploads/2019/12/RAJA-KONDAPALLI-1.png", link: "/target-ielts-and-immigration-center", details: "Visa Interview Preparation"},
    { id: 4, title: "Higher Study In USA With 70% Scholarship", img: "https://globalgateways.co.in/wp-content/uploads/2025/01/study-abroad-usa.jpg", link: "/visa-services/student-visa-application-from-bangladesh", details: "USA Visa Application"},
    { id: 5, title: "Higher Study In Europe With Full Funded Scholarship", img: "https://www.birtamodeducation.edu.np/wp-content/uploads/2023/06/study_in_europe.jpg", link: "/visa-services/europe-visa-application", details: "Study Abroad Visa Application"},
    { id: 6, title: "Australia Tourist Visa Application By Eammu Holidays", img: "https://static.joonsite.com/careerbrick/2411011532477466.png", link: "/visa-services/australia-visa-application", details: "Australia Visa Application"},
    { id: 7, title: "Schengen Visa Assistance By Eammu Holidays", img: "https://citizenshipbyinvestment.news/wp-content/uploads/2024/01/SchengenFeatured-1.jpg", link: "/visa-services/europe-visa-application", details: "Schengen Visa Application"},
    { id: 8, title: "Study In Russia With Full Funded Govt. Scholarship", img: "https://www.britannicaoverseas.com/storage/uploads/blogs/2025/09/26/study-in-russia_1742025452.webp", link: "/visa-services/student-visa-application-from-bangladesh" , details: "Russia Visa Application"},
  ];

  // Data for Special Offers (Airlines)
  const offerData = [
    { id: 1, title: "Fly to New Destinations with Up To 33% Off", logo: "https://hblimg.mmtcdn.com/content/hubble/img/bangkok/mmt/destination/m_Bangkok-landscape_l_400_640.jpg", color: "bg-blue-900", link: "/offers" , details: "Fly to New Destinations"},
    { id: 2, title: "Get Up to 32% Discount on Selected European Routes", logo: "https://img.freepik.com/free-photo/beautiful-girl-standing-boat-looking-mountains-ratchaprapha-dam-khao-sok-national-park-surat-thani-province-thailand_335224-849.jpg?semt=ais_user_personalization&w=740&q=80", color: "bg-orange-700", link: "/offers", details: "Get Up to 32% Discount" },
    { id: 3, title: "Best airline ticket offers for domestic flights With 15% off", logo: "/airline-discount-offer.webp", color: "bg-blue-800", link: "/offers", details: "Best airline ticket offers" },
    { id: 5, title: "Get Exclusive Deals on International Flights", logo: "https://img.freepik.com/premium-photo/airplane-landing-sunset_114775-23.jpg?semt=ais_user_personalization&w=740&q=80", color: "bg-blue-800", link: "/offers", details: "Get Exclusive Deals" },
    { id: 6, title: "Book cheap flights to top international destinations today.", logo: "/cheapflights_eammu_offer.webp", color: "bg-blue-800", link: "/offers", details: "Book cheap flights" },
    { id: 7, title: "Fly to new destinations with exclusive travel discounts get Up to 48% Off This Eid", logo: "https://media.istockphoto.com/id/1011241694/photo/thai-traditional-wooden-longtail-boat-and-beautiful-sand-beach.jpg?s=612x612&w=0&k=20&c=3Al0xNJgX7LXSiNFbbZFLG2DcHIEtO_XDdgvvRBImUk=", color: "bg-blue-800", link: "/offers", details: "Fly to new destinations" },
    { id: 8, title: "Travel the world with unbeatable airfare deals with Up to 38% Off This Eid", logo: "https://img.freepik.com/premium-photo/dubai-skyline-evening_114775-22.jpg?semt=ais_user_personalization&w=740&q=80", color: "bg-blue-800", link: "/offers", details: "Travel This Eid" },
                ...
                <div className="p-5 flex flex-col justify-between flex-grow">
                  ...
                  <div className="flex justify-end">
                    <a href={item.link} className="bg-[#005a31] hover:bg-yellow-500 text-white font-black text-[10px] py-[12px] px-4 rounded-lg flex items-center gap-2 uppercase transition-all">
                      {item.details} <ArrowRight size={14} />
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div className="p-5 flex flex-col justify-between flex-grow">
                  ...
                  <div className="flex justify-end">
                    <a href={visa.link} className="bg-[#005a31] hover:bg-yellow-500 text-white font-black text-[10px] py-[12px] px-4 rounded-lg flex items-center gap-2 uppercase transition-all">
                      {visa.details} <ArrowRight size={14} />
                    </a>
                  </div>
                </div>
              </div>
